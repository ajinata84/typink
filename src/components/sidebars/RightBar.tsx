      ...
      <div className="p-3">
        ...
        <ul>
          {recentActivities.map((activity, index) => (
            ...
            >
              <span className="text-sm text-gray-700 w-[80%] text-ellipsis overflow-hidden">{activity.title}</span>
              <span className="text-sm text-gray-500 w-[20%] text-center">{activity.count}</span>
            </Button>
          ))}
        </ul>
      </div>
